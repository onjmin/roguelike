...
//   暗転の あいだに 持ち場へ もどる（囲いの中の ロゼ・テトは 歩いては 帰れない）。語りは 保存しない（閉じたら それきり）。
...
// - 持ち帰った物（Town.pending）：テトが あずける物を きいて（一覧は ui/home.ts の chooseStored）、のこりを ロゼが 売り、
//   レイが 売り上げを 読む。町が 育ったら 暗転して 建て直し、建った所を 見せて「町が「…」に なった」。
 ...
 * 帰還スレで 帰って 倉庫が あれば テトが あずける物を きく。のこりは 売って レイが 売り上げを 読む。
 */

...
const PAGES: { value: string; label: string; sub: string; html: string }[] = [
	{
		...
		html:
			...
			lines([
				...
				"中断した　冒険は、はじめの　画面か　入口の　「冒険に　もどる」で　つづきが　できる。",
			]),
	},
	{
		value: "touch",
	...
	},
	{
		...
		html:
			...
			h("セーブ") +
			lines([
				"とちゅうで　やめても、つぎは　「冒険に　もどる」で　つづきから　もぐれる（はじめの　画面か　入口で。自動で　セーブ）。",
				"ぜんぶ　消して　はじめから　やりなおすなら、村の　せっていの　「セーブデータを　消す」。",
				"倒れたら、持ち物も　レベルも　なくなる。やりなおしは　できない。",
				"ダンジョンは　3つ。ちょっと過去ログの底（10階）→　過去ログの底（20階）→　もっと過去ログの底（30階）の　順に　開く。",
				"終わった　冒険は、村の　掲示板・レイか　メニューの　「冒険の記録」から　リプレイで　見返せる（新しい　20回ぶん）。「リプレイを　わたす」で　リンクにして　人に　見せられる。",
			]),
	},
	{
		value: "deck",
